...
This document defines the commit message convention used for this JavaScript study plan. The goal is to keep commits consistent, descriptive, and educational, so each commit clearly reflects what was learned or practiced.
...
`[optional longer description: explain why or how the change was made]`
...
Scopes represent topics or concepts in the study plan.

**Example scopes:** variables, functions, arrays, objects, loops, dom, events, promises, week1, week2
